 ...
 */
$GLOBALS['TL_DCA']['tl_reservation_settings'] = array
(
    // Config
    'config' => array
    (
            ...
            (
                array('tl_reservation_settings', 'checkConfig'),
            ),
    ...
    (
            ...
            'default'                     => '{title_legend},subject;{html_legend},content;{text_legend:hide},text;{attachment_legend},addFile;{template_legend:hide},template;{expert_legend:hide},sendText,externalImages,senderName,sender;{smtp_legend:hide},useSMTP'
    ),
    ...
    (
        ...
        'subject' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['subject'],
                'exclude'                 => true,
                'search'                  => true,
                'sorting'                 => true,
                'flag'                    => 1,
                ...
                'default'                 => $GLOBALS['TL_LANG']['tl_reservation_settings']['default_subject']
        ),
        'content' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['content'],
                'exclude'                 => true,
                'search'                  => true,
                'inputType'               => 'textarea',
                'eval'                    => array('rte'=>'tinyNews', 'helpwizard'=>true),
                'explanation'             => 'insertTags',
                'default'                 => $GLOBALS['TL_LANG']['tl_reservation_settings']['default_html_text'],
                'load_callback' => array
                (
                        array('tl_reservation_settings', 'convertAbsoluteLinks')
                ),
                'save_callback' => array
                (
                        array('tl_reservation_settings', 'convertRelativeLinks')
                ),
                'sql'                     => "mediumtext NULL"
        ),
        'text' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['text'],
                'exclude'                 => true,
                'search'                  => true,
                'inputType'               => 'textarea',
        ...
        'addFile' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['addFile'],
                'exclude'                 => true,
                'filter'                  => true,
                'inputType'               => 'checkbox',
        ...
        'files' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['files'],
                'exclude'                 => true,
                'inputType'               => 'fileTree',
        ...
        'template' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['template'],
                'default'                 => 'mail_default',
                'exclude'                 => true,
                'inputType'               => 'select',
                'options_callback'        => array('tl_reservation_settings', 'getMailTemplates'),
                'sql'                     => "varchar(32) NOT NULL default ''"
        ),
        'sendText' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['sendText'],
                'exclude'                 => true,
                'filter'                  => true,
                'inputType'               => 'checkbox',
        ...
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['externalImages'],
                'exclude'                 => true,
                'inputType'               => 'checkbox',
                'eval'                    => array('tl_class'=>'w50'),
                'sql'                     => "char(1) NOT NULL default ''"
        ...
        'sender' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['sender'],
                'exclude'                 => true,
                'search'                  => true,
                'filter'                  => true,
                'inputType'               => 'text',
        ...
        'senderName' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['senderName'],
                'exclude'                 => true,
                'search'                  => true,
                'sorting'                 => true,
                'flag'                    => 11,
        ...
        'useSMTP' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['useSMTP'],
                'exclude'                 => true,
                'inputType'               => 'checkbox',
                'eval'                    => array('submitOnChange'=>true),
                'sql'                     => "char(1) NOT NULL default ''"
        ...
        'smtpHost' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['smtpHost'],
                'exclude'                 => true,
                'inputType'               => 'text',
        ...
        'smtpUser' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['smtpUser'],
                'exclude'                 => true,
                'inputType'               => 'text',
        ...
        'smtpPass' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['smtpPass'],
                'exclude'                 => true,
                'inputType'               => 'textStore',
        ...
        'smtpEnc' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['smtpEnc'],
                'exclude'                 => true,
                'inputType'               => 'select',
        ...
        'smtpPort' => array
        (
                'label'                   => &$GLOBALS['TL_LANG']['tl_reservation_settings']['smtpPort'],
                'default'                 => 25,
                'exclude'                 => true,
                'inputType'               => 'text',
